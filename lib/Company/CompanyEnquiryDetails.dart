...
class CompanyEnquiryDetails extends StatefulWidget {
  final CompanyEnquiryModel enquirymodel;
  CompanyEnquiryDetails({required this.enquirymodel});
  @override
  State<CompanyEnquiryDetails> createState() => _CompanyEnquiryDetailsState();
}

class _CompanyEnquiryDetailsState extends State<CompanyEnquiryDetails> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child:  Text(
                        'Phone-${widget.enquirymodel.postedByUserPhone.substring(0,5)}****',
                  ...
                  ElevatedButton(onPressed: (){
                    Navigator.push(
                        ...
                        customPageRoute(EnquiryChat(
                          ...
                          companyid: widget.enquirymodel.companyid, wallid: widget.enquirymodel.wallid,  CompanyName: 'deWallads', companyphone: widget.enquirymodel.companyphone,
                        )));
